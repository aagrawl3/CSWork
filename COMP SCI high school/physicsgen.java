...
public class physicsgen 
{
	...
	public void findvelocity(double currenttime)
	{
		...
		double yvelocity = yinitial + -9.81 * currenttime;
	...
	public void multiplechoice() throws IOException
	{
		...
		if(type == 1)
		{
			for(int i=0; i<5; i++)
			{
				Answers[i] = ((double)((int)((a + 1.37 + (Math.random() * 10)) * 1000))) /1000; 
			}
			Answers[(int)(Math.random()*5.0)] = ((double)((int)(1000 * (a + 1.37))))/1000;
			BufferedWriter out = new BufferedWriter(new FileWriter("Problems.txt",true));
			...
			out.write("The answer is " + letters[(int)(Math.random()*5.0)]);
			out.newLine();
			out.newLine();
			out.close();
		...
		if(type == 2)
		{
			...
			for(int i=0; i<5; i++)
			{
				Answers[i] = ((double)((int)((b +(Math.random() * 10)) * 1000))) /1000; 
			}
		...
		if(type == 3)
		{
			for(int i=0; i<5; i++)
			{
				Answers[i] = ((double)((int)((c + (Math.random() * 10)) * 1000))) /1000; 
			}
		...
		for(int i=0; i<5; i++)
			{
				Answers[i] = ((double)((int)((d + (Math.random() * 40)) * 1000))) /1000; 
			}
		...
		for(int i=0; i<5; i++)
			{
				Answers[i] = ((double)((int)((e + 15.27 + (Math.random() * 30)) * 1000))) /1000;
			}
			Answers[(int)(Math.random()*5.0)] = ((double)((int)(1000 * (e + 15.27))))/1000;
			BufferedWriter out = new BufferedWriter(new FileWriter("Problems.txt",true));
